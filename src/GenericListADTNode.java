...
public interface GenericListADTNode<T> {
   ...
   *
   * @param converter function needed to convert T into R
   * @param <R>       type of the data in the returned list
   * @return head of a list that is structurally identical to this list, but contains data of type R
   */
